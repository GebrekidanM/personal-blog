...
function ContactPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setStatus('Sending...');
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"]}/contact`, {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=_bdf52947._.js.map