...
function ManagePostsPage() {
    ...
    const fetchPosts = async ()=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:4000/api/posts');
            setPosts(res.data);
    ...
    const handleDelete = async (postId)=>{
        ...
        try {
            const token = localStorage.getItem('authToken');
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:4000/api/posts/${postId}`, {
                headers: {
                    'x-auth-token': token
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd255889._.js.map